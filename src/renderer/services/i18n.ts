...
const translations: Record<LanguageType, Record<string, string>> = {
  zh: {
    ...
    usageTab: '用量统计',
    customModelUsageTitle: '自定义模型本机用量',
    customModelUsageDescription: '仅统计 LobsterAI 在本机记录到的自定义模型 token，用于趋势参考；实际用量和费用请以模型服务商后台为准。',
    usageRangeToday: '今日',
    usageRange7d: '7 天',
    usageRange30d: '30 天',
    usageRangeAll: '全部',
    ...
    usageSessionCount: '{count} 个会话',
    usageMessagesCount: '{count} 条消息',
    usageLastUsedAt: '最近使用',
    usageActivity: 'Token 活动',
    usageModelRanking: '常用模型',
    usageProviderRanking: '常用 Provider',
    usageNoDataTitle: '暂无自定义模型用量',
    usageNoDataDescription: '开始使用自定义模型后，LobsterAI 会在本机统计可见的 token 活动。',
    usageNoRankingData: '暂无排行数据',
    usageNoRecentUse: '暂无最近使用',
    usageLoadFailed: '加载自定义模型用量失败',
    shortcuts: '快捷键',
    about: '关于',
    aboutVersion: '版本',
  ...
  en: {
    ...
    usageTab: 'Usage',
    customModelUsageTitle: 'Local Custom Model Usage',
    ...
    usageSessionCount: '{count} sessions',
    usageMessagesCount: '{count} messages',
    usageLastUsedAt: 'Last Used',
    usageActivity: 'Token Activity',
    usageModelRanking: 'Top Models',
    usageProviderRanking: 'Top Providers',
    usageNoDataTitle: 'No custom model usage yet',
    usageNoDataDescription:
      'After you use a custom model, LobsterAI will show locally recorded token activity here.',
    usageNoRankingData: 'No ranking data',
    usageNoRecentUse: 'No recent use',
    usageLoadFailed: 'Failed to load custom model usage',
    shortcuts: 'Shortcuts',
    about: 'About',
